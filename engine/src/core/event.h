 ...
 * registration is found, this functions return FALSE. 
 ...
 * @return TRUE if the event is sucessfully unregistered; otherwise false.
 */
 ...
 * TRUE, the evens is considered handled and is not passed on to any more listeners.
